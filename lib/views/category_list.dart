...
//         for (int i = 0; i < document.data()['products'][k].length; i++) {
//           Item item = new Item(
//             document.data()['products'][k]['$i']['itemImage'],
//             document.data()['products'][k]['$i']['itemName'],
//             1,
//             document.data()['products'][k]['$i']['itemPrice'],
//             document.data()['products'][k]['$i']['numOrders'],
//             document.data()['products'][k]['$i']['itemCategory'],
//             '$i',
//           );
...
//       try {
//         for (int i = 0;
//             i < document.data()['products'][globals.category].length;
//             i++) {
//           Item item = new Item(
//             document.data()['products'][globals.category]['$i']['itemImage'],
//             document.data()['products'][globals.category]['$i']['itemName'],
//             1,
//             document.data()['products'][globals.category]['$i']['itemPrice'],
//             document.data()['products'][globals.category]['$i']['numOrders'],
//             document.data()['products'][globals.category]['$i']['itemCategory'],
//             '$i',
//           );
//           display_list.add(item);
//         }
...
//     } else
//       display_list.sort((b, a) => a.numOrders.compareTo(b.numOrders));
//   }
...
//                                   'products.${display_list[index].itemCategory}.${display_list[index].itemIndex}.numOrders':
...
//                                 'favorites.${display_list[index].itemName}.numOrders':
//                                     display_list[index].numOrders
//                               });
//                             } else {
//                               globals.favorite_name
